...
#java -javaagent:../libs/pia-2.0.3.jar -jar ../libs/dacapo-9.12-bach.jar avrora -s $1 #Uses the play-in agent of Tamifelxer. Unsure if needed as it causes errors in other tests. Feel free to comment this out if needed
echo "avrora.Main+main" > ../loadme.txt #Force Soot to read in this method in this class (In this case, read 'main' in 'avrora.Main'). Other methods may be needed in other Dacapo tests.
