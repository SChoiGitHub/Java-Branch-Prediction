...
#THE DIFFERENCE is the fact the other two arguements: -combined-data and -static-data. The arguement that comes after them are the names of the combined data and static data.
