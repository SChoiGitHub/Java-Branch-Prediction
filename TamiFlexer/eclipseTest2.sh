...
java -Xmx10G -cp "../libs/soot-trunk.jar:." ReadSpecificMethods -w -app -p cg.spark enabled -cp "$RT_JAR:$JCE_JAR:../libs/eclipse.jar:out:../libs/dacapo-9.12-bach.jar:." -include org.apache. -include org.w3c. -combined-data eclipse_cd -static-data eclipse_sd  -main-class Harness -d sootified/eclipse Harness
