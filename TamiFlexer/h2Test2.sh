...
java -Xmx10G -cp "../libs/soot-trunk.jar:." ReadSpecificMethods -w -app -p cg.spark enabled -cp "$RT_JAR:$JCE_JAR:../libs/derbyTesting.jar:../libs/junit-3.8.1.jar:../libs/h2-1.2.121.jar:../libs/tpcc.jar:out:../libs/dacapo-9.12-bach.jar:." -include org.apache. -include org.w3c. -combined-data h2_cd -static-data h2_sd  -main-class Harness -d sootified/h2 Harness
